...
class Blog
{
     ...
     * @var string
     *
     * @ORM\Column(name="optionalPhoto", type="string", length=255, nullable=true)
     */
    private $optionalPhoto;
     ...
     * Set optionalPhoto
     *
     * @param string $optionalPhoto
     *
     * @return Blog
     */
    public function setOptionalPhoto($optionalPhoto)
    {
